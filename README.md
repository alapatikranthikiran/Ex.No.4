...
To write the prompt for the following prompt types and compare that with different AI tools and evaluate that using any one evaluation method (eg. Rubrics).
